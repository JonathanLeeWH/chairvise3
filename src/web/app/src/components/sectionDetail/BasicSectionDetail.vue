    ...
    <el-row v-loading="sectionDetail.status.isLoading">
        <el-form status-icon ref="editForm" label-position="left" :model="editForm" label-width="170px"
            ...
            <div class="title" v-if="!isEditing">
                {{ sectionDetail.title }}
                <el-button type="warning" icon="el-icon-edit" circle @click="changeEditMode(true)"
                           v-if="isPresentationEditable"></el-button>
                <el-button type="danger" icon="el-icon-delete" circle v-if="isPresentationEditable"
                           @click="deleteSectionDetail"></el-button>
            </div>
            ...
            <div v-if="isEditing">
                ...
                <el-form-item v-if="isInAdvancedMode" v-for="(selection, index) in editForm.selections"
                    ...
                    <el-button type="danger" icon="el-icon-delete" circle
                               @click="removeSelection(selection)"></el-button>
                </el-form-item>

                <el-form-item label="Record Involved" prop="involvedRecords" v-if="isInAdvancedMode"
                              key="involvedRecords">
                    <el-select v-model="editForm.involvedRecords" multiple placeholder="Please select" filterable
                               allow-create>
                        <el-option
                ...
                <el-form-item v-if="isInAdvancedMode" v-for="(joiner, index) in editForm.joiners"
                              :label="'Joiner ' + index"
                              :key="'j' + index"
                ...
                <el-form-item v-if="isInAdvancedMode" v-for="(sorter, index) in editForm.sorters"
                              :label="'Sorting ' + index"
                              :key="'sort' + index"
                ...
                <el-form-item>
                    <el-button type="primary" @click="previewAnalysisResult('editForm')" plain icon="el-icon-view">
                        Preview
                    </el-button>
                    <el-button type="success" @click="saveSectionDetail('editForm')" icon="el-icon-check">Save
                    </el-button>
                    <el-button type="info" @click="cancelEditing" icon="el-icon-close">Cancel</el-button>
                    <el-dropdown @command="handleAddCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="filter">Filter</el-dropdown-item>
                            <el-dropdown-item command="selection" v-if="isInAdvancedMode">Selection</el-dropdown-item>
                            <el-dropdown-item command="joiner" v-if="isInAdvancedMode">Joiner</el-dropdown-item>
                            <el-dropdown-item command="sorting" v-if="isInAdvancedMode">Sorting</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-form-item>
            </div>
    ...
    methods: {
      ...
      removeSelection(selection) {
        this.$confirm('This will permanently delete the selection. Are you sure?', 'Deleting Selection', {
          ...
          this.$message({
            type: 'success',
            message: 'Successfully deleted the selection!'
          });
        }).catch(() => {
      ...
      removeJoiner(joiner) {
        this.$confirm('This will permanently delete the joiner. Are you sure?', 'Deleting Joiner', {
          ...
          this.$message({
            type: 'success',
            message: 'Successfully deleted the joiner!'
          });
        }).catch(() => {
          // Don't display any message
        });
      ...
      removeSorter(sorter) {
        this.$confirm('This will permanently delete the sorter. Are you sure?', 'Deleting Sorter', {
          ...
          this.$message({
            type: 'success',
            message: 'Successfully deleted the sorter!'
          });
        }).catch(() => {
          // Don't display any message
        });
