export default {
  ...
  "word_cloud_keywords_reviewer_comment": {
    ...
    data: {
      ...
      extraData: {
        delimiters: ['\\r', '\\n', '\\s'],
        ignoreWords: ["the", "to", "of", "and", "in", "a", "are", "is", "this",
          "it", "that", "on", "be", "have",
          "for", "as", "an", "would", "some", "there", "from", "or", "by",
          "they", "can", "with", "should", "how", "what",
          "at", "could", "if"],
      }
    }
  },
  ...
  */
  ...
  "review_weighted_evaluation_score_stats_summary": {
    ...
    data: {
      ...
      dataSet: '${PLACEHOLDER_DATA_SET}',
      description: 'This table shows the weighted evaluation score'
          + ' statistics based on the minimum, maximum value, the average,'
          + ' median score, standard deviation and the variance of the'
          + ' weighted evaluation scores. This gives us an insight on the'
          + ' evaluation score given by each reviewer in their review.',
      selections: [
        {
      ...
      sorters: [],
      extraData: {
        types: ['min', 'max', 'avg', 'median', 'std', 'var'],
      }
    }
  },
  "review_expertise_level_stats_summary": {
    ...
    data: {
      ...
      dataSet: '${PLACEHOLDER_DATA_SET}',
      description: 'This table shows the reviewer expertise level statistics'
          + ' based on the minimum, maximum value, the average, median'
          + ' score, standard deviation and the variance of the weighted'
          + ' evaluation scores. This gives us an insight on how specialized'
          + ' the reviewers are in their review.',
      selections: [
        {
  ...
  "review_confidence_level_stats_summary": {
    ...
    data: {
      ...
      dataSet: '${PLACEHOLDER_DATA_SET}',
      description: 'This table shows the reviewer confidence level'
          + ' statistics based on the minimum, maximum value, the average,'
          + ' median score, standard deviation and the variance of the'
          + ' weighted evaluation scores. This gives us an insight on how'
          + ' confident the reviewers are in their review.',
      selections: [
        {
