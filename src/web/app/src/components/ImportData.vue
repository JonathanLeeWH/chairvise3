<template>
    <div>
        <el-alert
            ...
            &nbsp;<el-button type="warning" plain size="mini" @click="navigateToHomePage">Return to the Home Page
        </el-button>
        </el-alert>
        <div v-if="isLogin">
            ...
            <div v-else class="upload-box">
                <div class="row">
                    <p class="thick">Step 1: Select conference paper</p>
                ...
                <div class="row">
                    <p class="thick">Step 2: Select record type</p>
                ...
                <div class="row">
                    <p class="thick">Step 3: Does the file has headers?</p>
                ...
                <div class="row">
                    <p class="thick">Step 4: Select predefined mapping</p>
                ...
                <div class="row">
                    <el-upload v-if="isReadyForUpload" drag action=""
                        ...
                        <div class="el-upload__tip" slot="tip">Only .csv files are accepted</div>
                    </el-upload>
                </div>
            </div>
        </div>
          ...
          complete: function (result) {
            ...
            if (this.$store.state.dataMapping.data.tableType == "1") {
              if (this.$store.state.dataMapping.data.formatType == "2") {
                var reviewres = [];
                reviewres.push(
                    ["Review Id", "Submission Id", "Num Review Assignment", "Reviewer Name", "Expertise Level",
                      "Review Comment", "Confidence Level", "Overall Evaluation Score", "Column 9", "Column 10",
                      "Column 11", "Column 12", "Day of the Review Date", "Time of the Review Date",
            ...
            if (this.$store.state.dataMapping.data.tableType == "2") {
              if (this.$store.state.dataMapping.data.formatType == "2") {
                var submissionres = [];
                submissionres.push(
                    ["#", "track #", "track name", "title", "authors", "submitted", "last updated", "form fields",
                      "keywords", "decision", "notified", "reviews sent", "abstract"]);
